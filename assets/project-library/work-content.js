    ...
    projects: {
      ...
      "data-quality-engine": {
        ...
        editorial: {
          ...
          responsibility: p(
            "As the named technical performer, I owned rule translation, architecture, implementation, versioning, and verification.",
            "기술 수행자로서 규칙 해석, 아키텍처, 구현, 버전 관리, 검증을 맡았습니다."
          ),
          build: p(
