      ...
      "inclusive-game-ai": {
        ...
        editorial: {
          ...
          outcomeSystem: p(
            ...
            "작동하는 GAIA 연구 플랫폼과 Explainer-Reader-Surrogate 모듈형 발전 로드맵을 구축해 후속 개발로 인계했습니다."
          ),
          outcomeEvidence: p(
    ...
    publications: {
      ...
      "pleth-ethical-llm": {
        editorial: {
          ...
          contribution: p("As co-first author, I co-led the development of PLETH, a few-shot prompting and LLM-as-a-judge framework combining twelve Hofstede-derived profiles, nine Moral Machine trolley scenarios, and four evaluation criteria.", "공동 제1저자로서 Hofstede 기반 12개 프로필, Moral Machine 트롤리 딜레마 9개, 4개 평가 기준을 결합한 few-shot·LLM-as-a-judge 프레임워크 PLETH의 개발을 공동 주도했습니다."),
      ...
      "gaia-service-framework": {
        editorial: {
          ...
          contribution: p("As co-first author, I co-designed a hybrid GAIA service framework and UX scenario that routes player difficulty to either a problem-solving strategy or an emotion-regulation strategy using game context and dialogue state.", "공동 제1저자로서 게임 맥락과 대화 상태에 따라 어려움을 문제 해결 전략 또는 감정 조절 전략으로 라우팅하는 하이브리드 GAIA 서비스 프레임워크와 UX 시나리오를 공동 설계했습니다."),
      ...
      "hybe-multilabel-review": {
        editorial: {
          ...
          contribution: p("As corresponding author, I co-authored a technical review framing HYBE's independent-label system as a case of decentralized management and differentiated creative strategy.", "교신저자로서 HYBE 독립 레이블 체계를 분산 경영과 차별화된 창작 전략 사례로 해석한 기술 문헌검토를 공동 집필했습니다."),
      ...
      "clustering-prediction": {
        editorial: {
          ...
          finding1: p("The framework groups products by both temporal shape and demand characteristics rather than by category labels alone.", "프레임워크는 범주 라벨만이 아니라 시간적 형태와 수요 특성을 함께 사용해 제품을 묶습니다."),
    ...
    awards: {
      ...
      "esg-ar-encouragement-prize": {
        ...
        editorial: {
          ...
          validates: p("Early external evidence of venture leadership and the ability to connect immersive technology with an environmental behavior model, recognized with the university President's Award.", "몰입형 기술을 환경 행동 모델과 연결한 초기 벤처 리더십의 외부 근거이며 총장상으로 인정받았습니다.")
        }
      },
